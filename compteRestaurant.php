                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                            ...
                            <li><a class="color_animation navactive" href="#reservation">RESERVATION</a></li>
                            <li><a class="color_animation" href="#contact" style="
                    ...
                    <div class="row">
                        <div id="w">
                            <ul id="filter-list" class="clearfix">
                                ...
                                <li class="filter active" data-filter="special">Special</li>
                                ...
                                <div class="row">
                                    <div class="col-lg-8 col-md-6 col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-6 ">
                                                <!-- Send Button -->
                                                <button type="submit" id="submit" name="submit" class="text-center form-btn form-btn" style="
    background: #f9b129;
">Reserve</button>
                                            </div>
        ...
        <section class="social_connect">
            <div class="text-content container">
                <div class="col-md-6">
                    <span class="social_heading" style="
    color: #f9b129;
">FOLLOW</span>
                            ...
                            <div class="contact-form">
                                ...
                                <form id="contact-us" method="post" action="contact.php">
                                    ...
                                    <div class="relative fullwidth col-xs-12">
                                        <!-- Send Button -->
                                        <button type="submit" id="submit" name="submit" class="form-btn" style="
    background: #f9b129;
">Send Message</button>
        ...
        <footer class="sub_footer">
            <div class="container">
                <div class="col-md-4"><p class="sub-footer-text text-center">© <a href="home.html">Feed Me</a></p></div>
