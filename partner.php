...
include("nav.php");
 ...
 <p>When you join Feed Me, your restaurant will not only benefit from Feed Me and TripAdvisor's visibility, but you can also increase revenue generated by your own website and social networks like Facebook.</p>
 <p><a class="Btn-normal" href="#">Learn more</a></p>
 					</div>
 				</div>
 ...
 <p>Specifically designed to meet the needs of your restaurant, from Feed Me manager software manages your reservations for you, giving you the right response, tailored for your customers and staff.</p>
 ...
 <p>It's easy to stay in touch with your customers, or let them know about your new menu or upcoming theme evenings by keeping them coming back.</p>
 <p><a class="Btn-normal" href="#">Learn more</a></p>
 					</div>
 				</div>
 		...
 		<section class="box__5">
 			<div class="row">
 				<h2><strong>It's a win-win partnership</strong>All services below are FREE for PREMUIM account: </h2>
 			</div>

 			<div class="row box__txt">
 				<p>You have free and unlimited access to all tools to promote your restaurant and generate more bookings. All reservations from your own website or your Facebook page are free. We only take a commission when reservations come from Feed Me or TripAdvisor sites. If we're not bringing you customers, you don't pay anything.</p>
 <p><a class="Btn-normal" href="#">See all services</a> <a class="Btn-normal type__action" href="#">See all rates</a></p>
 ...
 <div class="Form-signupnow type__page country_en">
 	<div class="row">
 		<h2>   - Try Feed Me without any commitment -</strong></h2>
 	</div>
 	<div class="row">
